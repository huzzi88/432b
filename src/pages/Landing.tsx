...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-cyan-900">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-white text-center mb-12">Getting Started Guides</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {guides.map((g, i) => (
              <button key={i} onClick={() => navigate(g.path)} className="bg-gradient-to-br from-cyan-900/50 to-purple-900/50 border border-cyan-400/30 rounded-lg p-6 hover:border-cyan-400 transition text-left">
      ...
      <section className="py-20 px-4 bg-black/30">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-white text-center mb-12">Resources</h2>
          <div className="grid md:grid-cols-5 gap-4">
            {infoPages.map((p, i) => (
              <button key={i} onClick={() => navigate(p.path)} className="bg-black/50 border border-purple-400/20 rounded-lg p-4 hover:border-purple-400 transition text-center">
      ...
      {/* CTA */}
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-cyan-900/50 to-purple-900/50 border border-cyan-400/30 rounded-2xl p-12">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Start Earning?</h2>
          <p className="text-xl text-gray-300 mb-8">Join Kepler432B today and start your investment journey.</p>
      ...
      {/* Footer */}
      <footer className="bg-black/50 border-t border-cyan-400/20 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <span className="text-3xl">🪐</span>
                <h3 className="text-xl font-bold text-white">Kepler432B</h3>
              </div>
              <p className="text-gray-400 text-sm">Your trusted investment platform for secure, automated returns.</p>
            </div>
            <div>
